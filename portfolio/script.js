...
function efectoHabilidades(){
    ...
    if(distancia_skills >= 300){
        ...
        habilidades[8].classList.add("nodejs");
        ...
        habilidades[13].classList.add("scrum");
        habilidades[14].classList.add("español");
        habilidades[15].classList.add("ingles");
        habilidades[16].classList.add("portugues");
        habilidades[17].classList.add("frances");
    }
}
